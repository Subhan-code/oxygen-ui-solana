  ...
  return (
    <div className="flex min-h-[460px] w-full flex-col items-center justify-center gap-8 p-6 font-sans select-none">
      <div className="flex flex-wrap items-center justify-center gap-8">
        <ProgressRing value={val} label="Storage Used" colorPreset="sky" />
        <ProgressRing value={88} label="Node Sync" colorPreset="emerald" />
        <ProgressRing value={45} label="Memory Limit" colorPreset="amber" />
      </div>
