              ...
              return (
                <div key={trader.handle} className="flex items-center justify-between p-1">
                  <div className="flex items-center gap-2.5">
                    <div className="relative flex h-9 w-9 items-center justify-center rounded-full bg-blue-950/60 border border-blue-800/50 font-bold text-blue-300 text-xs">
                      <span>⚡</span>
                    ...
                    <div>
                      ...
                      <p className="text-[11px] font-semibold text-blue-400">{trader.return}</p>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className={cn(
                      "rounded-full px-3 py-1 text-xs font-bold transition-transform active:scale-95 cursor-pointer",
                      isFollowing
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-2.5 space-y-2">
            {sites.map((site) => (
              <div key={site.name} className="flex items-center justify-between p-1 cursor-pointer group active:scale-98 transition-transform">
                <div className="flex items-center gap-2.5">
                  <div className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-zinc-900 border border-zinc-800 font-bold text-xs text-white">
                    <span>🌐</span>
                    <span className="absolute -bottom-1 -right-1 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-white text-[9px] font-bold text-zinc-950">
                      {site.rank}
                    </span>
