...
const CustomTokenInput = React.forwardRef<HTMLInputElement, React.ComponentProps<"input">>(
  ({ className, ...props }, ref) => (
    <input
      ref={ref}
      className={cn(
...
export type { TokenComboboxProps, TokenIconProps, TokenInputProps };
export { TokenCombobox, TokenIcon, TokenInput };
