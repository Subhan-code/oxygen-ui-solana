  ...
  },
{
  ...
  },
  {
    ...
    category: "Solana UI DeFi Primitives",
    registry: "action-box",
    description: "A configurable DeFi action form with token input, detail rows, and submit button.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/action-box.tsx`,
  },
  {
    name: "Activity Feed",
    ...
    description: "A real-time feed of recent Solana transactions and activity with token icons.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/activity-feed.tsx`,
  },
  {
    ...
    description: "Displays a truncated Solana wallet address with copy-to-clipboard button.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/address-display.tsx`,
  },
  {
    name: "Auth Card",
    ...
    category: "Solana UI DeFi Primitives",
    registry: "auth-card",
    description: "An authentication card with email/password form and social login for wallet dApps.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/auth-card.tsx`,
  },
  {
    name: "Health Bar",
    ...
    category: "Solana UI DeFi Primitives",
    registry: "health-bar",
    description: "A visual health and risk indicator bar transitioning from green to red.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/health-bar.tsx`,
  },
  {
    name: "Leverage Slider",
    href: "/components/leverageslider",
    category: "Solana UI DeFi Primitives",
    registry: "leverage-slider",
    description: "A slider for selecting trading leverage with min/max range and step increments.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/leverage-slider.tsx`,
  },
  {
    name: "NFT Card",
    href: "/components/nftcard",
    category: "Solana UI DeFi Primitives",
    registry: "nft-card",
    description: "A card for displaying Solana NFT artwork with collection details.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/nft-card.tsx`,
  },
  {
    name: "Order Book",
    ...
    category: "Solana UI DeFi Primitives",
    registry: "order-book",
    description: "A real-time order book display with bid/ask depth visualization and spread.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/order-book.tsx`,
  },
  {
    name: "Order Form",
    ...
    category: "Solana UI DeFi Primitives",
    registry: "order-form",
    description: "A take profit and stop loss order form for open positions.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/order-form.tsx`,
  },
  {
    name: "Pool Card",
    ...
    category: "Solana UI DeFi Primitives",
    registry: "pool-card",
    description: "A liquidity pool information card with token icons and sparkline chart.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/pool-card.tsx`,
  },
  {
    name: "Pool Table",
    ...
    category: "Solana UI DeFi Primitives",
    registry: "pool-table",
    description: "A sortable table of liquidity pools with token icon groups, TVL, and APY.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/pool-table.tsx`,
  },
  {
    name: "Position Card",
    href: "/components/positioncard",
    category: "Solana UI DeFi Primitives",
    registry: "position-card",
    description: "A card displaying an open trading position with leverage and P&L.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/position-card.tsx`,
  },
  {
    name: "Position Table",
    href: "/components/positiontable",
    category: "Solana UI DeFi Primitives",
    registry: "position-table",
    description: "A full table displaying open positions with side badges, entry prices, and P&L.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/position-table.tsx`,
  },
  {
    name: "Price Chart",
    href: "/components/pricechart",
    category: "Solana UI DeFi Primitives",
    registry: "price-chart",
    description: "An interactive price chart with area gradient, timeframes, and price metrics.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/price-chart.tsx`,
  },
  {
    name: "Sparkline Chart",
    href: "/components/sparklinechart",
    category: "Solana UI DeFi Primitives",
    registry: "sparkline-chart",
    description: "A compact SVG sparkline chart for displaying price trends.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/sparkline-chart.tsx`,
  },
  {
    name: "Stat Card",
    ...
    category: "Solana UI DeFi Primitives",
    registry: "stat-card",
    description: "A metric card for displaying key performance indicators and changes.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/stat-card.tsx`,
  },
  {
    name: "Swap Box",
    href: "/components/swapbox",
    category: "Solana UI DeFi Primitives",
    registry: "swap-box",
    description: "A DEX token swap box with token selection and slippage tolerance.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/swap-box.tsx`,
  },
  {
    name: "Token Combobox",
    href: "/components/tokencombobox",
    category: "Solana UI DeFi Primitives",
    registry: "token-combobox",
    description: "A searchable dropdown combobox for selecting SPL tokens with balances.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/token-combobox.tsx`,
  },
  {
    name: "Token Command",
    ...
    description: "A command palette dialog for token search and quick swaps.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/token-command.tsx`,
  },
  {
    name: "Token Icon",
    ...
    category: "Solana UI DeFi Primitives",
    registry: "token-icon",
    description: "A token logo icon component with fallback initials and border styling.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/token-icon.tsx`,
  },
  {
    name: "Token Icon Group",
    href: "/components/tokenicongroup",
    category: "Solana UI DeFi Primitives",
    registry: "token-icon-group",
    description: "An overlapping pair or group of token icons for liquidity pools.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/token-icon-group.tsx`,
  },
  {
    name: "Token Input",
    ...
    description: "A token amount input with MAX balance button and fiat estimate.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/token-input.tsx`,
  },
  {
    name: "Trade Box",
    ...
    category: "Solana UI DeFi Primitives",
    registry: "trade-box",
    description: "A perpetual trading box for long/short leverage positions.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/trade-box.tsx`,
  },
  {
    name: "Trade Buttons",
    href: "/components/tradebuttons",
    category: "Solana UI DeFi Primitives",
    registry: "trade-buttons",
    description: "Buy/Sell or Long/Short button pair for DEX trading interfaces.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/trade-buttons.tsx`,
  },
  {
    name: "Trade Chart",
    href: "/components/tradechart",
    category: "Solana UI DeFi Primitives",
    registry: "trade-chart",
    description: "A full candlestick/line chart for tracking token price history.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/trade-chart.tsx`,
  },
  {
    name: "Trend Badge",
    href: "/components/trendbadge",
    category: "Solana UI DeFi Primitives",
    registry: "trend-badge",
    description: "A percentage change badge with up/down arrows and status colors.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/trend-badge.tsx`,
  },
  {
    name: "Txn Table",
    ...
    category: "Solana UI DeFi Primitives",
    registry: "txn-table",
    description: "A transaction history table with status indicators and signatures.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/txn-table.tsx`,
  },
  {
    name: "Txn Toast",
    ...
    category: "Solana UI DeFi Primitives",
    registry: "txn-toast",
    description: "A toast notification for transaction confirmation status.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/txn-toast.tsx`,
  },
  {
    name: "Wallet Sheet",
    href: "/components/walletsheet",
    category: "Solana UI DeFi Primitives",
    registry: "wallet-sheet",
    description: "A slide-over drawer sheet for wallet connection and token list.",
    source: `${REGISTRY_HOMEPAGE}/blob/main/components/ui/sol/wallet-sheet.tsx`,
  },
];
